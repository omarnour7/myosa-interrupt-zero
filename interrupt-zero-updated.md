...
image: interrupt-zero/cover.jpg
tags:
  - MYOSA
  - ESP32
  - Automotive
...
* A companion mobile app (Flutter, cross-platform) for BLE telemetry sync and forensic export — currently in active development
...
<p align="center">
  <img src="/assets/images/interrupt-zero/oled-dashboard.jpg" width="800"><br/>
...
Pair the board with the Interrupt Zero Flutter companion app over BLE to receive live telemetry and automatic crash-event exports (app integration in progress).
...
* **Bluetooth Low Energy (BLE)** — async telemetry sync (firmware-side complete)
* **Flutter** — cross-platform companion app for telemetry, forensic export, and alerts (in development)
